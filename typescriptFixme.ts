...
var mySearch = function (func : fn) : boolean {
  return func.src.search(func.sub) != -1;
};
...
class Tuple <Type1,Type2>{
  item1 : Type1
  item2 : Type2
  constructor(item1 : Type1, item2 : Type2) {
    this.item1 = item1;
    this.item2 = item2;
  }
}
...
function pairToTuple<type>(pair : Pair<type>) : Tuple<type,type> {
...
// annotate this array
var arrayOfAnyType : (string|number|boolean)[] = [1, "string", false];
